...
public class EventTestComplete {
    ...
    public void testConflictSameTimesDifferentLocation() {
        EventComplete e1 = new EventComplete(this.nine45, this.ten45, "Warren");
        EventComplete e2 = new EventComplete(this.nine45, this.ten45, "York");
    ...
    public void testConflictContained() {
        EventComplete e1 = new EventComplete(this.nine45, this.ten45, "Warren 2005");
        EventComplete e2 = new EventComplete(this.farPast, this.farFuture, "Warren 2005");
    ...
    public void testConflictBackToBack() {
        EventComplete e1 = new EventComplete(this.nine45, this.ten45, "Warren 2005");
        EventComplete e2 = new EventComplete(this.ten45, this.eleven45, "Warren 2005");
    ...
    public void testConflictOverlap() {
        EventComplete e1 = new EventComplete(this.nine45, this.ten45, "CSE 260B");
        EventComplete e2 = new EventComplete(this.ten30, this.eleven45, "CSE 260B");
